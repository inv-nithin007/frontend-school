            ...
            if user_role == 'student':
                try:
                    ...
                    user_data.update({
                        ...
                        'assigned_teacher_subject': student.assigned_teacher.subject if student.assigned_teacher else None,
                        'assigned_teacher_qualification': student.assigned_teacher.qualification if student.assigned_teacher else None,
                        'assigned_teacher_experience': student.assigned_teacher.experience_years if student.assigned_teacher else None,
                    })
